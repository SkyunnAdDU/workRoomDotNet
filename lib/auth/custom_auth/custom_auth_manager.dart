...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    workRoomDotNetAuthUserSubject.add(
      WorkRoomDotNetAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<WorkRoomDotNetAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  WorkRoomDotNetAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = WorkRoomDotNetAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    workRoomDotNetAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
WorkRoomDotNetAuthUser? currentUser;
